...
am_app_info <- function(store, store_application_id, signature, accept = "text/csv") {
  app_info <- GET(
    glue("https://api.appmagic.rocks/v1/applications/{store}/{store_application_id}/info"),
    add_headers(
