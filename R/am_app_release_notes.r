...
am_app_release_notes <- function(store, store_application_id, signature, accept = "text/csv") {
  app_release_notes <- GET(
    glue("https://api.appmagic.rocks/v1/applications/{store}/{store_application_id}/release-notes"),
    add_headers(
