...
am_app_similarity <- function(store, store_application_id, signature, accept = "text/csv") {
  app_similarity <- GET(
    glue("https://api.appmagic.rocks/v1/applications/{store}/{store_application_id}/similarity"),
    add_headers(
